...
## [1.4.0-worldlabs.3] - 2026-07-28

### Added

- Added a modular per-splat effect framework with matching render and depth-sort deformation,
...
- The hurricane and sparse cloud now share a deterministic GPU-selected splat subset. Cloud
  points grow monotonically, settle and wobble in place, then a glowing radial ripple reveals
  all remaining splats and stabilizes the completed scene.
...
[unreleased]: https://github.com/wuyize25/gsplat-unity/compare/v1.4.0...HEAD
[1.4.0]: https://github.com/wuyize25/gsplat-unity/compare/v1.3.0...v1.4.0
